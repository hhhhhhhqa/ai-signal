...
### Twitter/X (22 accounts)
**Analysts:** Karpathy, Swyx, Dylan Patel (SemiAnalysis), Irrational Analysis,
Simon Willison (LLM tooling, open source), Artificial Analysis (independent
model benchmarks), Naval Ravikant, Leopold Aschenbrenner, Jim Keller
