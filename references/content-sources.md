...
Guillermo Rauch (Vercel), Amjad Masad (Replit), Josh Woodward (Google Labs),
Paul Gauthier (Aider), Ivan Fioravanti (Apple MLX / open source),
Dean Ball (OpenAI Strategic Futures),
Kun Chen (FirstMate / ex-Meta L8)
