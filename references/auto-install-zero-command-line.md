...
When a user asks you to install ai-signal (e.g. "帮我安装 https://github.com/hhhhhhhqa/ai-signal"
...
2. Clone and install:
```bash
git clone https://github.com/hhhhhhhqa/ai-signal.git <install_path>
...
3. If clone or install fails, diagnose and retry (missing git? missing pip?
   ...
   `git clone https://gh-proxy.com/https://github.com/hhhhhhhqa/ai-signal.git <install_path>`
   or `git clone https://ghfast.top/https://github.com/hhhhhhhqa/ai-signal.git <install_path>`
